...
from mmseg.models import BaseSegmentor, BaseSegmentorEvents, BaseSegmentorFusion, build_segmentor
...
class UDADecorator(BaseSegmentor):
    ...
    def __init__(self, **cfg):
        ...
        self.train_cfg = cfg['model']['train_cfg']  # dict()
        self.test_cfg = cfg['model']['test_cfg']  # dict(mode='whole')
        self.num_classes = cfg['model']['decode_head']['num_classes']  # 19
...
class UDADecoratorEvents(BaseSegmentorEvents):

    def __init__(self, **cfg):
        super(BaseSegmentorEvents, self).__init__()
    ...
    def simple_test(self, rescale=True, **kwargs):
        """Simple test with single image."""
        return self.get_model().simple_test(rescale=True, **kwargs)
...
class UDADecoratorFusion(BaseSegmentorFusion):

    def __init__(self, **cfg):
        super(BaseSegmentorFusion, self).__init__()
